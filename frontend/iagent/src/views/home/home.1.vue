        ...
        getUserInfo() {
           let ret= {
            ...
            if (Cookies.get('user') != 'undefined' ) {
                ret.userinfo.user       = Cookies.get('user');
            }
            if (Cookies.get('login_ip') != 'undefined' ) {
                ret.userinfo.login_ip   = Cookies.get('login_ip');
            }
            if  ( Cookies.get('login_time') != 'undefined') {
                ret.userinfo.login_time = this.formatDate(Cookies.get('login_time'));
            }
            ret.userinfo.sessionid  = Cookies.get('sessionid');
